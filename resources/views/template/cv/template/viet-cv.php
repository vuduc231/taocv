                            ...
                            <div class="col-lg-4 col-xlg-3 col-md-5">
                                <div class="card-body profile-card">
                                    <div class="text-center">
                                        ...
                                        <h4 class="editable card-title mt-2" contenteditable data-placeholder="Vũ Minh Đức"></h4>
                                    </div>
                                    <div class="row text-left justify-content-center">
                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-person-vcard-fill"></i> Thông tin cá nhân </h5>
                                        ...
                                        <div class="col-12">
                                            <div class="mt-3">
                                                <div class="form-group d-flex">
                                                    ...
                                                    <div class="editable" contenteditable
                                                        data-placeholder="091 921 6886"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-bar-chart-line-fill"></i> Mục tiêu sự nghiệp</h5>
                                        
                                        <div class="col-12">
                                            <div class="editable" contenteditable data-placeholder="Áp dụng những kinh nghiệm của một nhân viên chuyên nghiệp. Từ đó giúp Công ty tăng doanh số"></div>
                                        </div>

                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-aspect-ratio-fill"></i> Kỹ năng </h5>
                            ...
                            <div class="col-lg-8 col-xlg-9 col-md-7">
                                <div class="card-body profile-card">
                                    <form>
                                        ...
                                        <h5 class="position-relative font-medium vietcv-title"><i class="bi bi-mortarboard-fill"></i> Học vấn</h5>
                                            ...
                                            <div id="render_container">
                                                <div id="render-block" class="form-group">
                                                    ...
                                                    <div class="block-two">
                                                        ...
                                                        <div class="editable  mt-2" contenteditable data-placeholder="Mô tả quá trình học tập hoặc thành tích của bạn"></div>
                                                    </div >
                                                </div>
                                            </div>
                                            <div class="action_wrapper">
                                                <button class="btn btn-outline-success" id="btn-add-block" style="display: none;" type="button">
                                                    <i class="bi bi-plus-circle"></i>
                                                    <!-- <span>Thêm mục</span> -->
                                                </button>
                                                <button class="btn btn-danger" id="btn-delete-block" style="display: none;" type="button">
                                        ...
                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-bar-chart-steps"></i> Kinh nghiệm</h5>
                                            ...
                                            <div id="render_container">
                                                <div id="render-block" class="form-group">
                                                    <div class="block-one d-flex">
                                                        ...
                                                        <div class="editable" contenteditable data-placeholder="Tên công ty"></div>
                                                        <span style="padding:0 10px">//</span>
                                                        <div class="editable" contenteditable data-placeholder="Bắt đầu - Kết thúc"></div>
                                                    </div>
                                                    <div class="block-two">
                                                        <div class="editable  mt-2" contenteditable data-placeholder="Vị trí công việc"></div>
                                                        <div class="editable  mt-2" contenteditable data-placeholder="Mô tả hoạt động"></div>
                                                    </div >
                                                </div>
                                            </div>
                                            <div class="action_wrapper">
                                        ...
                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-pin-map-fill"></i> Hoạt động</h5>
                                            ...
                                            <div id="render_container">
                                                <div id="render-block" class="form-group">
                                                    <div class="block-one d-flex">
                                                        ...
                                                        <div class="editable" contenteditable data-placeholder="Vị trí công việc"></div>
                                                        <span style="padding:0 10px">//</span>
                                                        <div class="editable" contenteditable data-placeholder="Bắt đầu - Kết thúc"></div>
                                                    </div>
                                                    <div class="block-two">
                                                        <div class="editable  mt-2" contenteditable data-placeholder="Tên tổ chức"></div>
                                                        <div class="editable  mt-2" contenteditable data-placeholder="Mô tả hoạt động"></div>
                                                    </div >
                                                </div>
                                            </div>
                                        ...
                                        <h5 class="position-relative font-medium mt-4 vietcv-title"><i class="bi bi-flag-fill"></i> Chứng chỉ</h5>
                                        
                                        <div class="col-12" id="wrapper_render" >
                                            <div id="render_container">
                                                <div id="render-block" class="form-group d-flex ">
                                                    <i class="bi bi-briefcase"></i>
                                                    <div class="editable" contenteditable data-placeholder="Thời gian"></div>
                                                    <span style="padding:0 10px">//</span>
                                                    <div class="editable" contenteditable data-placeholder="Tên chứng chỉ"></div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <p><i class="bi bi-pencil-square"></i> Người khai thông tin ( Ký, ghi rõ họ tên )</p>
                                                <div class="editable " contenteditable data-placeholder="Kí tên: Nguyễn Văn A"></div>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="font-medium vietcv-title"><i class="bi bi-postcard-fill"></i> Thông tin cá nhân<sup>( Bổ Sung )</sup>
                    </h5>
                    <hr />
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="editable" contenteditable data-placeholder="Nơi ĐKHK thường trú (bao gồm: Số nhà, Phường/Xã, Quận/Huyện, Tỉnh/Thành Phố )"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mt-3">
                                <div class="editable" contenteditable data-placeholder="Tình trạng hiện tại (Độc thân/Đã kết hôn)"></div>
                            </div>
                            <div class="mt-3">
                                <div class="form-group">
                    ...
                    <h5 class="font-medium mt-4 vietcv-title"><i class="bi bi-person-lines-fill"></i> Thông tin gia đình</h5>
                    <hr />
                    <div class="col-md-12">
                        <div class="wrapper_render">
                            <div class="form-group">
                                <div class="editable" contenteditable data-placeholder="Bao gồm (Họ và tên - Mối quan hệ - Ngày sinh) - Nghề nghiệp - Nơi công tác - Số điện thoại"></div>
                            </div>
                    ...
                    <h5 class="font-medium mt-4 vietcv-title"><i class="bi bi-calendar2-week-fill"></i> Quá trình đào tạo ( kể cả các khóa
                        học ngắn hạn )</h5>
                    <hr />
                    <div class="form-group">
                        <div class="col-12">
