      ...
      <div class="container" data-aos="fade-up">
        <div class="bg-white p-3 rounded shadow-sm mb-4">
          <div class="box_information d-flex justify-content-between align-items-center">
            <div class="box_image">
              <img src="https://cdn.topcv.vn/80/company_logos/5h3k4RJxJKeccgPflonFIf8LgHvrPLTM_1675216726____a3bd1d29f32726ac02d54a19e8707f6d.png" />
            </div>
            ...
            <div class="box_action">
              ...
              ><i class="bi bi-send-check pe-2"></i>Ứng tuyển ngay</button>
              <span class="p-1"></span>
              <a href="mau-cv" class="btn btn-outline-success w-100"><i class="bi bi-plus-circle pe-2"></i> Tạo CV</a>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <div class="box_job-data">
                  ...
                  <div class="box_job-tab">
                      <p>- Đầy đủ chế độ</p>
                      <p>- Lương trên 10 Triệu ( Nhiều hỗ trợ phụ cấp, deal lương theo năng lực nếu có khả năng hơn )</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ứng tuyển <b class="text-success">R & D Team Leader For Self-Study Programs</b></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        <label
                            >Chọn CV online:
                            <span class="italic text-primary" style="font-style: italic;font-size:12px"><i class="bi bi-hand-thumbs-up-fill"></i> Khuyên dùng</span></label
                        >
                        <a href="mau-cv" class="btn btn-success d-block mt-3"><i class="bi bi-plus-lg"></i> Chọn CV ngay</a>
                      ...
                      <div class="col-md-6">
                        <div class="drop_box-wrapper">
                          ...
                          <div class="drop_box">
                            ...
                            <input type="file" name="dropbox_upload-img" hidden accept=".doc,.docx,.pdf" id="fileID" style="display:none;">
                            <button class="btn btn-outline-success"><i class="bi bi-cloud-upload"></i> Chọn file</button>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                      <label class="mt-3 fw-bold" style="font-size:14px">Thư giới thiệu: </label>
                        <textarea style="font-size:12px" rows="4" class="form-control ps-0 form-control-line" placeholder="Viết giới thiệu ngắn gọn về bản thân (điểm mạnh, điểm yếu) và nêu rõ mong muốn, lý do làm việc tại công ty này. Đây là cách gây ấn tượng với nhà tuyển dụng nếu bạn có chưa có kinh nghiệm làm việc (hoặc CV không tốt)."></textarea>
                      </div>
                    </div>
